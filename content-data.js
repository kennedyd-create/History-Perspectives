...
const masterQuizData = [
            ...
            { q: "Which belief most shaped Hirohito's decision-making in August 1945?", opts: ["Democracy and free elections", "Preservation of the Kokutai", "Alliance with Germany", "Expansion of the empire"], ans: 1, exp: "Correct! Kokutai — the preservation of the Imperial system — was Hirohito's central value." },
            ...
            { q: "How did Soviet entry into the war affect the perspectives of the US and Japanese leadership differently?", opts: ["It reassured both sides equally", "For the US it added pressure to end the war quickly; for Japan it removed the last hope of a negotiated peace via Soviet mediation", "It had no real impact on either side", "It only affected the US"], ans: 1, exp: "Correct! The same event (Soviet invasion) shaped each side's perspective very differently." },
            { q: "What is a key similarity between the US and Japanese perspectives in August 1945?", opts: ["Both wanted the war to end, even though they wanted different outcomes from it", "Both wanted the war to continue indefinitely", "Both supported total Japanese military defeat", "Both rejected the idea of surrender"], ans: 0, exp: "Correct! Despite their differences, both sides ultimately wanted the war to end." },
            ...
            { q: "Why might an answer that only describes two perspectives, without comparing them, be capped at Achieved?", opts: ["Because the standard requires explicit comparison and explanation of why perspectives differed, not just description", "Because two perspectives is too many to include", "Because Achieved-level answers must be short", "Because comparison is optional for this standard"], ans: 0, exp: "Correct! Describing two perspectives shows knowledge, but the standard rewards comparing them and explaining the difference." }
        ];
